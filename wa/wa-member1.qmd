...
convert_to_numeric <- funtion(value){
...
wrangling_race <- function(data){
  data |> 
    ...
    mutate(white_population = convert_to_numeric(white_population),
           ...
           pacific_islander = convert_to_numeric(pacific_islander),
           other = convert_to_numeric(other),
           two_or_more = convert_to_numeric(two_or_more)) |> 
    mutate(majority = case_when(white_population > black_african_american & white_population > native_american & white_population > asian & white_population > pacific_islander & white_population > other & white_population > two_or_more ~ "White",
                                black_african_american > white_population & black_african_american > native_american & black_african_american > asian & black_african_american > pacific_islander & black_african_american > other & black_african_american > two_or_more ~ "Black/African American",
                                native_american > white_population & native_american > black_african_american & native_american > asian & native_american > pacific_islander & navtive_american > other & native_american > two_or_more ~ "Native American",
                                asian > white_population & asian > black_african_american & asian > native_american & asian > pacific_islander & asian > other & asian > two_or_more ~ "Asian",
                                pacific_islander > white_population & pacific_islander > black_african_american & pacific_islander > native_american & pacific_islander > asian & pacific_islander > other & pacific_islander > two_or_more ~ "Pacific Islander",
                                other > white_population & other > black_african_american & other > native_american & other > asian & other > pacific_islander & other > two_or_more ~ "Other",
                                two_or_more > white_population & two_or_more > black_african_american & two_or_more > native_american & two_or_more > asian & two_or_more > pacific_islander & two_or_more > other ~ "Two or More"))
}

# This function helps us wrangle the education data
wrangling_education <- function(date){
  data |>
    select(geometry,variable,estimate) |> 
  ...
  mutate(none = convert_to_numeric(none),
         ...
         majority_educated = case_when(none > pre_highschool & none > highschool_or_equivalent & none > some_college & none > undergraduate & none > graduate ~ "None",
