...
```{r making base maps, fig.width = 10, fig.height=10}
# San Francisco White Population Map
cols <- c("#edf8fb", "#b2e2e2","#66c2a4","#2ca25f","#006d2c")

ggplot2::ggplot()+
  geom_sf(data = sanfrancisco_white_population,
          aes(fill = cat),
          color = "black",
          size = 0.5
          )+
  ...
  scale_fill_manual(
    name = "% of Population that is White",
    values = cols
  )+
  guides(
    fill = guide_legend(
  ...
  labs(
    title = "San Francisco White Population Density 2021"
  )+
  theme_void()+
  coord_sf(clip = "off")+
  theme(
