...
cols <- c("#8289fe", "#fedf60","#056c6b", "#fe8127", "#6c31fd")
sanfrancisco_race_map <- make_sanfrancisco(data = sanfrancisco_race, variable = sanfrancisco_race$majority, title_text =  "San Francisco County Race Distribution", legend_name = "Majority", colors = cols)
...
mesa_race_map <-make_mesa(data = mesa_race, mesa_race$majority, "Race Distribution in Maricopa County", "Majority", cols)
...
```{r combinging maps}
# figuring out how to combine graphs
race_map_sf <- image_read("sanfrancisco_race_map.png")
race_map_mesa <- image_read("mesa_race.png")
race_maps <- image_append(c(race_map_sf,race_map_mesa))
image_write(race_maps, path = "race_maps.png", format = "png")
```

![race_maps](race_maps.png)
